...
/**
 * This class was copied from origin BranchActionGroupPopup
 */
...
//                new AnAction(DvcsBundle.lazyMessage("action.MyAbstractBranchActionGroupPopup.Anonymous.text.restore.size"), CollapseComponentHover) {
//                    @Override
